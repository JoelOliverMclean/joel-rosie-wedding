...
import { FoodPreference } from "prisma-client-a41d7ee3267ae843ff9eddb9a0683fb339026ccb0d0fde836a0f34b515878687";
    ...
    <section>
      ...
      <div className="w-full">
        <div className="flex items-end gap-1 self-start px-4 select-none">
          ...
          <div
            className={`rounded-t-xl bg-transparent px-4 py-2 pt-3 text-transparent shadow-black duration-300 select-none`}
          >
            boop
          </div>
        </div>
